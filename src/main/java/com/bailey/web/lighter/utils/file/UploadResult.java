...
public  class UploadResult {
    ...
    public void addFile(String fieldName, String origFileName, long fileSize, String fileType, String serverFileName, String serverFileRelativePath, String serverFileAbsolutePath) {
        UploadFileInfo file = new UploadFileInfo(fieldName, origFileName, fileSize, fileType, serverFileName, serverFileRelativePath, serverFileAbsolutePath);
        files.add(file);
    }
